...
public class VideoCoursesPage extends TestBase {
    ...
    private ElementsCollection textBodyCheck = $$("body"); //nb, $$

    // actions
    public void setButtonMoreAboutVEDRec() { buttonMoreAboutVEDRec.click(); } //кнопка "Подробнее" (в блоке "Курс PRO ВЭД (Запись)")
    ...
    public void checkTextInBody(String textInBody) {
        textBodyCheck.find(text(textInBody)).shouldBe(visible);
    }
